...
{
    public $orderType = "";
    /** @var getTransactionDb */
    private $getTransactionDb;

    public function __construct()
    {
        $this->getTransactionDb = new getTransactionDb();
    }

    public function show(...$args): Response
    {
    ...
    public function storing(Order $order): Order
    {
        $request = request();
        $warehouse = warehouse();
    ...
    /**
     * @throws RelatedResourceNotFoundException|ApiException
     */
     ...
     * @throws ApiException
     */
    public function updating(Order $order): Order
    {
        ...
        if ($orderPaymentCount > 0) {
            throw new ApiException("Not able to edit because this order linked to some payments. Delete those payment(s) and try again.");
        }
     ...
     */
    public function update(...$args): Response
    {
        $this->getTransactionDb->getBeginTransaction();
     ...
     * @throws RelatedResourceNotFoundException
     */
    public function destroy(...$args): Response
    {
        $this->getTransactionDb->getBeginTransaction();
